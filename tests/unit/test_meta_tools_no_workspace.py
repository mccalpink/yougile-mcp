...
Эти тулы не делают API-вызовов (отдают статичную схему / манифест),
поэтому требовать у них workspace — антипаттерн: ломает онбординг
новых пользователей, у которых ещё ни одного ключа не настроено.
"""
import asyncio
import sys
